...
@section('head-tag')
    <title>ایجاد تصاویر گالری</title>
@endsection
...
@section('contain')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد تصاویر گالری</li>
        </ol>
    </nav>
                             ...
                             <section class="row">
                                 ...
                                 <div class="form-check col" style="cursor: pointer">
                                   <a> <img src="{{ asset('admin-assets/images/1.jpg') }}"></a>
                                     <input type="radio" class="form-check-input" name="currentImage" value="medium" >
                                 </div>
                                 <div class="form-check col" style="cursor: pointer">
                                     <a> <img src="{{ asset('admin-assets/images/2.jpg') }}"></a>
                                     <input type="radio" class="form-check-input" name="currentImage" value="small" >
                                 </div>
                                 <div class="form-check col" style="cursor: pointer">
                                     <a> <img src="{{ asset('admin-assets/images/3.jpg') }}"></a>
                                     <input type="radio"  class="form-check-input" name="currentImage" value="large" >
                                 </div>
                             </section>
                         </div>
