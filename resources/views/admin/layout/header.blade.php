...
{{--                            <img class="header-avatar" src="{{ asset( $LoggedUserInfo['image']['indexArray']['medium'] ) }}" alt="">--}}
{{--                            <span class="header-username"> {{ $LoggedUserInfo['name'] }} </span>--}}
...
{{--                                <i class="fas fa-sign-out-alt"></i>تنظیمات--}}
{{--                            </a>--}}
{{--                            <a href="{{ route('admin.user.edit',  $LoggedUserInfo['id']) }}" class="list-group-item list-group-item-action header-profile-link">--}}
{{--                                <i class="fas fa-user"></i>ویرایش مشخصات کاربر--}}
{{--                            </a>--}}
