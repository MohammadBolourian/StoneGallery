    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.slider.update',$slider->id) }}" method="post"  enctype="multipart/form-data" id="form" >
                        @csrf
                        {{ method_field('put') }}
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="name" id="name" value="{{ old('name',$slider->name) }}">
                                </div>
                                @error('name')
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    <label for="">متن </label>
                                    <textarea name="body" id="body"  class="form-control form-control-sm" rows="5">{{ old('body',$slider->body) }}</textarea>
                                </div>
                                @error('body')
                                <span class=" bg-danger text-white p-1 rounded" role="alert">
                                <strong>
